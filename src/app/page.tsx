            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-card p-6 rounded-lg border">
                ...
                <p className="text-muted-foreground mb-4">
                  Create, search, update, and delete payees using natural
                  language commands.
                </p>
                <ul className="text-sm text-muted-foreground space-y-2">
                  <li>
                    • &ldquo;Add a new payee called John&apos;s Coffee
                    Shop&rdquo;
                  </li>
                  <li>
              ...
              <div className="bg-card p-6 rounded-lg border">
                ...
                <p className="text-muted-foreground mb-4">
                  Organize your income and expense categories with AI
                  assistance.
                </p>
                <ul className="text-sm text-muted-foreground space-y-2">
                  <li>
                    • &ldquo;Create an expense category for office
                    supplies&rdquo;
                  </li>
                  <li>• &ldquo;Show me all income categories&rdquo;</li>
                  <li>• &ldquo;Make a subcategory under Marketing&rdquo;</li>
                  <li>
                    • &ldquo;List all categories in a tree structure&rdquo;
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Communicate in plain English - the AI understands your
                    intent and executes the appropriate actions.
                  </p>
                </div>
                <div>
                  <h3 className="font-medium mb-2">Smart Clarification</h3>
                  <p className="text-sm text-muted-foreground">
                    When requests are ambiguous, the AI asks clarifying
